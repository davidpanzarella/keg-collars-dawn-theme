(function (w) {
  ...
  destjs.src = 'https://x.clearbitjs.com/v2/pk_97f3ebd2b9d19a285aa3ba468a1d4154/destinations.min.js';
  ...
  w.clearbit._writeKey = 'pk_97f3ebd2b9d19a285aa3ba468a1d4154';
  ...
  if (!tracking.initialize) {
    if (tracking.invoked) {
      ...
      clearbitjs.src = 'https://x.clearbitjs.com/v2/pk_97f3ebd2b9d19a285aa3ba468a1d4154/tracking.min.js';
  ...
  })(
    {
      BHXf: [
        function (require, module, exports) {
          ...
          function a() {
            var e;
            return !!(null === (e = null === window || void 0 === window ? void 0 : window.mixpanel) || void 0 === e
              ? void 0
              : e.people);
          }
          function l() {
          ...
          function c() {
            var i = (window.__test_location_pathname || window.location.pathname || '').toLowerCase();
          ...
          function v(e, i, n) {
            ...
            if (i) {
              var a =
                ...
                (null === (o = null === window || void 0 === window ? void 0 : window.sessionStorage) || void 0 === o
                  ? void 0
                  : o.setItem);
              if (
                a &&
                (null === (r = (t = window.sessionStorage).getItem) || void 0 === r ? void 0 : r.call(t, 'cbi')) ===
                  i.toString()
              )
                return !1;
              ...
              if (
                ((l.method = e),
                null === (d = null === window || void 0 === window ? void 0 : window.clearbit) || void 0 === d
                  ? void 0
                  : d.identify)
              )
                return window.clearbit.identify(i, l), a && window.sessionStorage.setItem('cbi', i.toString()), !0;
            }
            return !1;
          }
      ...
      bOht: [
        function (require, module, exports) {
          ...
          Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.wrapAmplitudeIdentify = void 0);
          var n = require('./util');
          function o(e) {
                            ...
                            try {
                              if (!s.__isProxy) {
                                ...
                                if (i(u)) m = o(r([], u._q, !0));
                                  ...
                                  (g = u.getUserProperties()) && (m = t(t({}, g.$set || {}), g.$setOnce || {}));
                                } else if ('object' === e(u.userPropertiesOperations)) {
                                  var g;
                                  (g = u.userPropertiesOperations) && (m = t(t({}, g.$set || {}), g.$setOnce || {}));
                                }
                                (v = (null == p ? void 0 : p.user_id) ? p.user_id : (0, n.extractUserIdFromTraits)(m)),
      ...
      ybEZ: [
        function (require, module, exports) {
          'use strict';
          Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.wrapFormSubmit = void 0);
          var e = require('./util');
          function t() {
      ...
      rXKW: [
        function (require, module, exports) {
          ...
          Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.wrapHeapUserProperties = void 0);
          var e = require('./util');
          function o() {
            (null === window || void 0 === window ? void 0 : window.heap) &&
              (window.heap = new Proxy(window.heap, {
                get: function (o, n, i) {
                  for (var a = this, p = [], c = 3; c < arguments.length; c++) p[c - 3] = arguments[c];
                  return (
                    '__isProxy' === n ||
                    ('addUserProperties' === n
                      ? function () {
      ...
      fqEG: [
        function (require, module, exports) {
          ...
          Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.wrapMixpanelPeople = void 0);
          var o = require('./util');
          function r() {
            var r;
            (null === (r = null === window || void 0 === window ? void 0 : window.mixpanel) || void 0 === r
              ? void 0
              : r.people) &&
      ...
      rxXe: [
        function (require, module, exports) {
          ...
          Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.wrapSegmentIdentify = void 0);
          var r = require('./util');
          function o() {
                          ...
                          try {
                            if (!o.__isProxy) {
                              ...
                              'string' == typeof c[0]
                                ...
                                : 'object' === t(c[0]) && ((p = c[0]), (l = (0, r.extractUserIdFromTraits)(p))),
      ...
      GliP: [
        function (require, module, exports) {
          'use strict';
          Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.wrapWindowFetch = void 0);
          var e = require('./util');
          function t() {
                    ...
                    if ('string' == typeof s && s.length < 512) {
                      ...
                      f
                        ...
                        : s.forEach(function (t) {
                            t && 'string' == typeof t && (0, e.looksLikeBusinessEmail)(t) && (a = t);
                          });
                    }
